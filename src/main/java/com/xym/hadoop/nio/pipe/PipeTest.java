package com.xym.hadoop.nio.pipe;
...
public class PipeTest {
  ...
  private static ReadableByteChannel startWorker(int reps) throws Exception {
    ...
    Worker worker = new Worker(sink, reps);
    worker.start();
  ...
  // -----------------------------------------------------------------
  /**
   * A worker thread object which writes data down a channel. Note: this object knows nothing about
   * Pipe, uses only a generic WritableByteChannel.
   */
