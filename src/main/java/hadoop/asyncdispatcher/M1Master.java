...
public class M1Master extends CompositeService {
	...
	public void serviceInit(final Configuration conf) throws Exception {
		...
		dispatcher.register(Event1.class, new M1(dispatcher.getEventHandler()));
